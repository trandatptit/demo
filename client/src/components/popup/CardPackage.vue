<template>
  <div class="relative">
    ...
    >
      <span
        class="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-bold px-6 py-2 rounded-full shadow-lg"
      >
        {{ badge }}
      </span>
    </div>
      ...
      <template #content>
        <slot name="content" :props="props">
          ...
          <div v-if="warning" class="text-center mb-4">
            <div
              class="inline-block bg-red-100 dark:bg-red-900/30 px-5 py-3 rounded-lg"
            >
          ...
          <div class="flex gap-4 mt-1">
            <Button
              ...
              :class="[
                ...
                flag ? 'opacity-60 secondary-button' : 'primary-button',
              ]"
